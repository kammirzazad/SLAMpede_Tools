...
then
	...
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 330.29ms 36.75ms distribution cloud_4_2_o1_b1 loss 3.81%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 309.74ms 37.57ms distribution cloud_4_2_o0_p0 loss 1.96%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 302.96ms 37.59ms distribution cloud_4_2_b0_p0 loss 1.27%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 329.39ms 36.77ms distribution cloud_4_2_p1_b1 loss 4.26%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.95ms 37.57ms distribution cloud_4_2_p0_b1 loss 2.94%
