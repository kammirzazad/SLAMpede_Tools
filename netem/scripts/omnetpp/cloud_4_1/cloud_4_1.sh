...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 341.18ms 37.33ms distribution cloud_4_1_o1_p1 loss 0.0518%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.2ms 37.94ms distribution cloud_4_1_o0_o1 loss 0.0211%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 333.97ms 38.8ms distribution cloud_4_1_b1_o1 loss 0.0367%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 300.02ms 37.16ms distribution cloud_4_1_b0_o1 loss 0.0134%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.02ms 36.6ms distribution cloud_4_1_p0_o1 loss 0.0308%
