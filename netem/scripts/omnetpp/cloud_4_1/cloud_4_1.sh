...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 340.64ms 37.13ms distribution cloud_4_1_o1_p1 loss 0.0518%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.59ms 38.41ms distribution cloud_4_1_o0_o1 loss 0.0211%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 332.82ms 38.66ms distribution cloud_4_1_b1_o1 loss 0.0367%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 300.33ms 37.39ms distribution cloud_4_1_b0_o1 loss 0.0134%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.68ms 36.47ms distribution cloud_4_1_p0_o1 loss 0.0308%
