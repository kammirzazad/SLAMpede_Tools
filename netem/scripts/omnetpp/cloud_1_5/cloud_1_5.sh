...
then
	...
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 331.56ms 37.23ms distribution cloud_1_5_o1_b1 loss 3.77%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 309.14ms 37.13ms distribution cloud_1_5_o0_b1 loss 2.51%
...
then
	...
	# apply delay to each band
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 329.08ms 36.78ms distribution cloud_1_5_b1_p1 loss 4.18%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 301.53ms 38.34ms distribution cloud_1_5_b0_p0 loss 1.19%
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:3 handle 11: netem delay 303.14ms 36.56ms distribution cloud_1_5_b0_o0 loss 1.4%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.52ms 37.64ms distribution cloud_1_5_p0_o1 loss 3.03%
