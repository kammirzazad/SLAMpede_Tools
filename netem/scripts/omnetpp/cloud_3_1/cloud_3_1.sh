...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 341.34ms 37.2ms distribution cloud_3_1_o1_p1 loss 5.18%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.07ms 37.97ms distribution cloud_3_1_o0_b1 loss 2.11%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 332.9ms 38.73ms distribution cloud_3_1_b1_o1 loss 3.93%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 299.85ms 37.31ms distribution cloud_3_1_b0_b1 loss 1.34%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.16ms 36.44ms distribution cloud_3_1_p0_b1 loss 3.08%
