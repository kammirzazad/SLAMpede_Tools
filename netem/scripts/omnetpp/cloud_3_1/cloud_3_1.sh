...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 340.91ms 36.89ms distribution cloud_3_1_o1_p1 loss 5.18%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.52ms 38.37ms distribution cloud_3_1_o0_b1 loss 2.11%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 332.59ms 37.98ms distribution cloud_3_1_b1_o1 loss 3.93%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 300.27ms 36.94ms distribution cloud_3_1_b0_b1 loss 1.34%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 318.65ms 36.32ms distribution cloud_3_1_p0_b1 loss 3.08%
