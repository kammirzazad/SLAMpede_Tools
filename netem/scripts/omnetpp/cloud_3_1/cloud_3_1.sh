...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 340.65ms 37.13ms distribution cloud_3_1_o1_p1 loss 0.0518%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.21ms 38.11ms distribution cloud_3_1_o0_b1 loss 0.0211%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 333.36ms 38.64ms distribution cloud_3_1_b1_o1 loss 0.0393%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 299.94ms 36.93ms distribution cloud_3_1_b0_b1 loss 0.0134%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.21ms 36.61ms distribution cloud_3_1_p0_b1 loss 0.0308%
