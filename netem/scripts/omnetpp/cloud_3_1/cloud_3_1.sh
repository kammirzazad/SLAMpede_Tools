...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 340.93ms 37.21ms distribution cloud_3_1_o1_p1 loss 0.0518%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.46ms 38.38ms distribution cloud_3_1_o0_b1 loss 0.0211%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 332.83ms 38.72ms distribution cloud_3_1_b1_o1 loss 0.0393%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 299.95ms 37.02ms distribution cloud_3_1_b0_b1 loss 0.0134%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.58ms 36.53ms distribution cloud_3_1_p0_b1 loss 0.0308%
