...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 341.72ms 36.88ms distribution cloud_2_4_o1_p1 loss 0.0485%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 309.08ms 36.12ms distribution cloud_2_4_o0_p0 loss 0.0237%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay infms infms distribution cloud_2_4_b1_p0 loss 0.0281%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 303.41ms 37.04ms distribution cloud_2_4_b0_o0 loss 0.0112%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 318.75ms 36.49ms distribution cloud_2_4_p0_o1 loss 0.0331%
