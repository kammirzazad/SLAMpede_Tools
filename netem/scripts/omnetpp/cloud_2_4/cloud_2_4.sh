...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 341.57ms 36.94ms distribution cloud_2_4_o1_p1 loss 0.0485%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 309.0ms 36.01ms distribution cloud_2_4_o0_p0 loss 0.0237%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.49ms 37.99ms distribution cloud_2_4_b1_p0 loss 0.0281%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 303.17ms 36.82ms distribution cloud_2_4_b0_o0 loss 0.0112%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 318.85ms 36.5ms distribution cloud_2_4_p0_o1 loss 0.0331%
