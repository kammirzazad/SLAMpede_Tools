...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 341.7ms 36.85ms distribution cloud_2_4_o1_p1 loss 4.85%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 309.15ms 36.06ms distribution cloud_2_4_o0_p0 loss 2.37%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.55ms 38.0ms distribution cloud_2_4_b1_p0 loss 2.81%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 303.23ms 36.85ms distribution cloud_2_4_b0_o0 loss 1.12%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 318.57ms 36.69ms distribution cloud_2_4_p0_o1 loss 3.31%
