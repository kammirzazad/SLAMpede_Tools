...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 339.63ms 36.51ms distribution cloud_2_5_o1_p1 loss 0.0503%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 310.39ms 38.18ms distribution cloud_2_5_o0_p0 loss 0.0237%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 302.72ms 37.13ms distribution cloud_2_5_b0_o0 loss 0.0126%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 330.91ms 37.0ms distribution cloud_2_5_p1_b1 loss 0.0411%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.52ms 37.23ms distribution cloud_2_5_p0_b1 loss 0.0299%
