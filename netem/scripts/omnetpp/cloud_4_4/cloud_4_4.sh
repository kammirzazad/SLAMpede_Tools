...
then
	...
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.8ms 37.09ms distribution cloud_4_4_o1_p0 loss 2.99%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 310.96ms 36.82ms distribution cloud_4_4_o0_p0 loss 1.81%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.13ms 37.33ms distribution cloud_4_4_b1_p0 loss 3.05%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 302.3ms 37.49ms distribution cloud_4_4_b0_o0 loss 1.17%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.55ms 37.08ms distribution cloud_4_4_p1_p0 loss 3.11%
