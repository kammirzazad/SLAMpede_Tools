...
then
	...
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.41ms 37.17ms distribution cloud_4_4_o1_p0 loss 0.0299%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 310.54ms 36.36ms distribution cloud_4_4_o0_p0 loss 0.0181%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.53ms 37.55ms distribution cloud_4_4_b1_p0 loss 0.0305%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 302.13ms 37.74ms distribution cloud_4_4_b0_o0 loss 0.0117%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.31ms 37.19ms distribution cloud_4_4_p1_p0 loss 0.0311%
