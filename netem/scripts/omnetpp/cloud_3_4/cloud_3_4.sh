...
then
	...
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.48ms 37.43ms distribution cloud_3_4_o1_p0 loss 3.05%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.52ms 37.03ms distribution cloud_3_4_o0_p0 loss 2.25%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 302.1ms 37.63ms distribution cloud_3_4_b0_o0 loss 1.29%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 329.11ms 36.85ms distribution cloud_3_4_p1_b1 loss 4.11%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.91ms 37.14ms distribution cloud_3_4_p0_b1 loss 2.99%
