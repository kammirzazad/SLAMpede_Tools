...
then
	...
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.42ms 37.21ms distribution cloud_3_4_o1_p0 loss 3.05%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.53ms 37.3ms distribution cloud_3_4_o0_p0 loss 2.25%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 302.14ms 37.74ms distribution cloud_3_4_b0_o0 loss 1.29%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 328.58ms 36.48ms distribution cloud_3_4_p1_b1 loss 4.11%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.06ms 37.39ms distribution cloud_3_4_p0_b1 loss 2.99%
