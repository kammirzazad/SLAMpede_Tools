...
then
	...
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.13ms 37.26ms distribution cloud_3_4_o1_p0 loss 0.0305%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.13ms 36.92ms distribution cloud_3_4_o0_p0 loss 0.0225%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 302.23ms 37.68ms distribution cloud_3_4_b0_o0 loss 0.0129%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 328.34ms 36.26ms distribution cloud_3_4_p1_b1 loss 0.0411%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.03ms 37.44ms distribution cloud_3_4_p0_b1 loss 0.0299%
