...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 341.08ms 37.19ms distribution cloud_2_1_o1_p1 loss 5.18%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.18ms 37.76ms distribution cloud_2_1_o0_p0 loss 2.11%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 332.95ms 39.08ms distribution cloud_2_1_b1_o1 loss 3.93%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 299.9ms 37.15ms distribution cloud_2_1_b0_p0 loss 1.34%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.02ms 36.49ms distribution cloud_2_1_p0_b1 loss 3.35%
