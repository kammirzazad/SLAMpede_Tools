...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 340.96ms 37.35ms distribution cloud_2_1_o1_p1 loss 0.0518%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.1ms 38.25ms distribution cloud_2_1_o0_p0 loss 0.0211%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 332.98ms 38.47ms distribution cloud_2_1_b1_o1 loss 0.0393%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 300.18ms 37.21ms distribution cloud_2_1_b0_p0 loss 0.0134%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 318.69ms 36.58ms distribution cloud_2_1_p0_b1 loss 0.0335%
