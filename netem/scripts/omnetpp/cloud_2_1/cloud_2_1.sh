...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 340.8ms 37.11ms distribution cloud_2_1_o1_p1 loss 5.18%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.24ms 38.1ms distribution cloud_2_1_o0_p0 loss 2.11%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 333.06ms 38.74ms distribution cloud_2_1_b1_o1 loss 3.93%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 300.12ms 37.09ms distribution cloud_2_1_b0_p0 loss 1.34%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.18ms 36.62ms distribution cloud_2_1_p0_b1 loss 3.35%
