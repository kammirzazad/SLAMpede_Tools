...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 341.15ms 37.07ms distribution cloud_2_1_o1_p1 loss 0.0518%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.06ms 38.08ms distribution cloud_2_1_o0_p0 loss 0.0211%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 333.31ms 38.73ms distribution cloud_2_1_b1_o1 loss 0.0393%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 299.86ms 36.98ms distribution cloud_2_1_b0_p0 loss 0.0134%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 318.98ms 36.72ms distribution cloud_2_1_p0_b1 loss 0.0335%
