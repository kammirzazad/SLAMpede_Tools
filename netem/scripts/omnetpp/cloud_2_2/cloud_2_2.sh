...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 339.34ms 37.06ms distribution cloud_2_2_o1_p1 loss 4.93%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 310.17ms 36.32ms distribution cloud_2_2_o0_p0 loss 2.18%
...
then
	...
	# apply delay to each band
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 330.26ms 37.69ms distribution cloud_2_2_b1_p1 loss 4.31%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 301.45ms 37.66ms distribution cloud_2_2_b0_p0 loss 1.21%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.18ms 37.98ms distribution cloud_2_2_p0_b1 loss 3.29%
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:3 handle 11: netem delay 320.57ms 36.51ms distribution cloud_2_2_p0_o1 loss 3.25%
