...
then
	...
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.36ms 36.58ms distribution cloud_2_3_o1_p0 loss 3.01%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.58ms 36.97ms distribution cloud_2_3_o0_p0 loss 2.47%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 331.99ms 38.68ms distribution cloud_2_3_b1_o1 loss 4.28%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 300.57ms 37.0ms distribution cloud_2_3_b0_o0 loss 1.26%
...
then
	...
	# apply delay to each band
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.03ms 37.3ms distribution cloud_2_3_p0_p1 loss 2.83%
