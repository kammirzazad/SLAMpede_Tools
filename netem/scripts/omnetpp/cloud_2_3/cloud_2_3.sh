...
then
	...
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 321.39ms 36.5ms distribution cloud_2_3_o1_p0 loss 0.0301%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.42ms 36.96ms distribution cloud_2_3_o0_p0 loss 0.0247%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 331.94ms 38.65ms distribution cloud_2_3_b1_o1 loss 0.0428%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 300.7ms 36.95ms distribution cloud_2_3_b0_o0 loss 0.0126%
...
then
	...
	# apply delay to each band
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.02ms 37.37ms distribution cloud_2_3_p0_p1 loss 0.0283%
