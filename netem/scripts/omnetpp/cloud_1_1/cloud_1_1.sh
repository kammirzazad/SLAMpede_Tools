...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 340.18ms 37.99ms distribution cloud_1_1_o1_p1 loss 0.0484%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 312.66ms 37.08ms distribution cloud_1_1_o0_b1 loss 0.0214%
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:3 handle 10: netem delay 309.09ms 35.98ms distribution cloud_1_1_o0_p0 loss 0.0219%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 329.59ms 37.17ms distribution cloud_1_1_b1_o1 loss 0.0406%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 300.43ms 37.12ms distribution cloud_1_1_b0_o0 loss 0.0147%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.67ms 37.7ms distribution cloud_1_1_p0_o1 loss 0.0341%
