...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 340.26ms 38.37ms distribution cloud_1_1_o1_p1 loss 4.84%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 312.24ms 36.69ms distribution cloud_1_1_o0_b1 loss 2.14%
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:3 handle 11: netem delay 308.76ms 35.97ms distribution cloud_1_1_o0_p0 loss 2.19%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 329.48ms 37.26ms distribution cloud_1_1_b1_o1 loss 4.06%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 300.8ms 37.23ms distribution cloud_1_1_b0_o0 loss 1.47%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.18ms 37.47ms distribution cloud_1_1_p0_o1 loss 3.41%
