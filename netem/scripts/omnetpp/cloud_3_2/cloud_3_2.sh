...
then
	...
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.01ms 37.81ms distribution cloud_3_2_o0_p0 loss 1.8%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 330.22ms 36.8ms distribution cloud_3_2_b1_o1 loss 3.8%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 301.43ms 36.28ms distribution cloud_3_2_b0_p0 loss 1.12%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 329.33ms 37.51ms distribution cloud_3_2_p1_b1 loss 4.19%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.77ms 37.24ms distribution cloud_3_2_p0_b1 loss 3.2%
