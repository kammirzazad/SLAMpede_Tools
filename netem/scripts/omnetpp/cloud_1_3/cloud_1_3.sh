...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:1 handle 10: netem delay 340.99ms 37.2ms distribution cloud_1_3_o1_p1 loss 0.0518%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:1 handle 10: netem delay 311.09ms 37.94ms distribution cloud_1_3_o0_p0 loss 0.0238%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:1 handle 10: netem delay 333.13ms 38.72ms distribution cloud_1_3_b1_o1 loss 0.0393%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:1 handle 10: netem delay 300.08ms 37.16ms distribution cloud_1_3_b0_o0 loss 0.0134%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:1 handle 10: netem delay 319.15ms 36.55ms distribution cloud_1_3_p0_b1 loss 0.0335%
