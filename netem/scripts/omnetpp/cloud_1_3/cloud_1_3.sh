...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 340.94ms 37.12ms distribution cloud_1_3_o1_p1 loss 5.18%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.15ms 37.88ms distribution cloud_1_3_o0_p0 loss 2.38%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 333.15ms 38.69ms distribution cloud_1_3_b1_o1 loss 3.93%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 300.11ms 37.19ms distribution cloud_1_3_b0_o0 loss 1.34%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 319.09ms 36.43ms distribution cloud_1_3_p0_b1 loss 3.35%
