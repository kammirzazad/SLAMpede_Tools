...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 341.15ms 36.64ms distribution cloud_1_4_o1_p1 loss 0.049%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.62ms 37.15ms distribution cloud_1_4_o0_b1 loss 0.0226%
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:3 handle 10: netem delay 308.78ms 36.69ms distribution cloud_1_4_o0_p0 loss 0.025%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.3ms 37.23ms distribution cloud_1_4_b1_p0 loss 0.0315%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 302.07ms 37.31ms distribution cloud_1_4_b0_o0 loss 0.013%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 318.68ms 38.1ms distribution cloud_1_4_p0_o1 loss 0.0353%
