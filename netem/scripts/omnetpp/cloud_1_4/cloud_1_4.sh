...
then
	...
	# -- pink1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 341.23ms 36.78ms distribution cloud_1_4_o1_p1 loss 4.9%
...
then
	...
	# apply delay to each band
	# -- blue1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 311.54ms 37.08ms distribution cloud_1_4_o0_b1 loss 2.26%
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:3 handle 11: netem delay 309.08ms 36.84ms distribution cloud_1_4_o0_p0 loss 2.5%
...
then
	...
	# apply delay to each band
	# -- pink0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 320.25ms 37.4ms distribution cloud_1_4_b1_p0 loss 3.15%
...
then
	...
	# apply delay to each band
	# -- orange0
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 302.29ms 37.1ms distribution cloud_1_4_b0_o0 loss 1.3%
...
then
	...
	# apply delay to each band
	# -- orange1
	sudo tc qdisc add dev eth0 parent 1:2 handle 10: netem delay 318.64ms 37.39ms distribution cloud_1_4_p0_o1 loss 3.53%
